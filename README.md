...
* **Hard Test:** Developed a robust `deseq2()` wrapper with 5 Passed `Pytest` cases, covering successful workflows, data type validation, index consistency, and design factor integrity.
